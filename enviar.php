...
// Mudar Aqui o e-mail
$email_envio = 'contato@frontbackstudio.000webhostapp.com'; // E-mail do site (ex: contato@seusite.com)
$email_pass = 'frontbackpg'; // Senha do e-mail

$site_name = 'FrontBack Studio'; // Nome do Site
$site_url = 'www.frontbackstudio.000webhostapp.com'; // URL do Site

$host_smtp = 'smtp.frontbackstudio.000webhostapp.com'; // HOST SMTP Ex: smtp.domain.com.br
